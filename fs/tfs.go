...
// XXX: This code is forked from https://github.com/nanovms/ops
// Original license: MIT
// Original copyright: NanoVMs
...
func getStringSlice(parent *map[string]interface{}, child string) []string {
	value := (*parent)[child]
	if value == nil {
		return nil
	}
...
func (t *tfs) getStringSlice(name string) []string {
	return getStringSlice(t.root, name)
}
